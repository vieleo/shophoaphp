...
?>
<table style="width:100%; text-align: center;border-collapse: collapse;"border="1 soid">
  <tr>
    <th>Id</th>
    <th>Mã sản phẩm</th>
    <th>Tên sản phẩm</th>
  ...
  <tr>
   ...
   ?>
    <tr>
        <td colspan="8">
          <p style="float: left;">Tổng tiền:<?php echo number_format($tongtien).'vnđ'?></p><br/>
       ...
       if(isset($_SESSION['dangky'])){
        ?>
        <p><a href="sanpham.php?quanly=thanhtoan">Đặt hàng</a></p>
        <?php 
      }else{
        ?>
